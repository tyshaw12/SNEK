...
class HandleCollisionsAction(Action):
    ...
    The responsibility of HandleCollisionsAction is to handle the situation when the snake collides with itself or the other snake.
    ...
    def _handle_game_over(self, cast):
        """Shows the 'game over' message and turns the snake and white if the game is over.
